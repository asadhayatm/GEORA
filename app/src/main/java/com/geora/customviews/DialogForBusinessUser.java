...
public class DialogForBusinessUser extends Dialog {
    ...
    public DialogForBusinessUser(Context context, DialogCallback dialogCallback) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.db_business_user);
        setCancelable(false);
