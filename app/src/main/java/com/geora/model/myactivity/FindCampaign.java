...
public class FindCampaign implements Parcelable {
    ...
    @Expose
    private GetDefaultImage getDefaultImage;
    ...
    public GetDefaultImage getGetDefaultImage() {
        return getDefaultImage;
    }

    public void setGetDefaultImage(GetDefaultImage getDefaultImage) {
    ...
    protected FindCampaign(Parcel in) {
        ...
        this.getImage = new ArrayList<GetImage>();
        in.readList(this.getImage, GetImage.class.getClassLoader());
        this.getDefaultImage = in.readParcelable(GetDefaultImage.class.getClassLoader());
    }

    public static final Parcelable.Creator<FindCampaign> CREATOR = new Parcelable.Creator<FindCampaign>() {
        @Override
        public FindCampaign createFromParcel(Parcel source) {
            return new FindCampaign(source);
        }

        @Override
        public FindCampaign[] newArray(int size) {
            return new FindCampaign[size];
        }
    };
}
