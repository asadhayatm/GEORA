...
public class GetCampaign_ implements Parcelable {
    ...
    @Expose
    private List<GetImage__> getImage = null;
    @SerializedName("get_default_image")
    @Expose
    private GetDefaultImage__ getDefaultImage;
    ...
    public List<GetImage__> getGetImage() {
        return getImage;
    }

    public void setGetImage(List<GetImage__> getImage) {
        this.getImage = getImage;
    }

    public GetDefaultImage__ getGetDefaultImage() {
        return getDefaultImage;
    }

    public void setGetDefaultImage(GetDefaultImage__ getDefaultImage) {
    ...
    private GetCampaign_(Parcel in) {
        ...
        this.getImage = new ArrayList<GetImage__>();
        in.readList(this.getImage, GetImage__.class.getClassLoader());
        this.getDefaultImage = in.readParcelable(GetDefaultImage__.class.getClassLoader());
    }

    public static final Parcelable.Creator<GetCampaign_> CREATOR = new Parcelable.Creator<GetCampaign_>() {
        @Override
        public GetCampaign_ createFromParcel(Parcel source) {
            return new GetCampaign_(source);
        }

        @Override
        public GetCampaign_[] newArray(int size) {
            return new GetCampaign_[size];
        }
    };
}
