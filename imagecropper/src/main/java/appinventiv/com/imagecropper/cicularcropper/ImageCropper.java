...
public final class ImageCropper {
    ...
    /**
     * The key used to pass crop image source URI to {@link ImageCropperActivity}.
     */
    public static final String CROP_IMAGE_EXTRA_SOURCE = "CROP_IMAGE_EXTRA_SOURCE";

    /**
     * The key used to pass crop image options to {@link ImageCropperActivity}.
     */
    public static final String CROP_IMAGE_EXTRA_OPTIONS = "CROP_IMAGE_EXTRA_OPTIONS";

    /**
     * The key used to pass crop image result data back from {@link ImageCropperActivity}.
     */
    ...
    /**
     * The request code used to start {@link ImageCropperActivity} to be used on result to identify the this specific
     * request.
     */
    public static final int CROP_IMAGE_ACTIVITY_REQUEST_CODE = 203;

    /**
     * The result code used to return error from {@link ImageCropperActivity}.
     */
    ...
    /**
     * Start an activity to get image for cropping using gallery intent that will have common
     * applications for the device galery (Photos), photos apps , etc.<br>
     * Use "pick_image_intent_chooser_title" string resource to override pick chooser title.
     *
     * @param activity the activity to be used to start activity from
     * @param requestCode to start activity so that get specific callback in OnActivityResult
     * @param cropperRequestCode to start Cropper Activity activity so that get specific callback in OnActivityResult
     */
    public static void startPickImageFromGalleryActivity(@NonNull Activity activity, int requestCode,int cropperRequestCode) {
        if(!isExplicitStoragePermissionRequired(activity)){
            if (getPickImageFromGalleryIntent(activity).resolveActivity(activity.getPackageManager()) != null) {
                CROPPER_REQUEST_CODE=cropperRequestCode;
                activity.startActivityForResult(getPickImageFromGalleryIntent(activity), requestCode);
            }
        }else {
...
//        }
     ...
     * @param cropperRequestCode to start Cropper Activity activity so that get specific callback in OnActivityResult
     */
    public static void startCaptureImageActivity(@NonNull Activity activity, int requestCode,int cropperRequestCode) {
        if(!isExplicitCameraPermissionRequired(activity)){
            CROPPER_REQUEST_CODE=cropperRequestCode;
            activity.startActivityForResult(getImageFromCameraIntent(activity), requestCode);
        }else {
    ...
    /**
     * get image Uri which is capture by intent camera
     * @return
     */
     ...
     * @param context used to access Android APIs, like content resolve, it is your activity/fragment/widget.
     */
    public static Intent getImageFromCameraIntent(@NonNull Context context) {
        Intent takePictureIntent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        if (takePictureIntent.resolveActivity(context.getPackageManager()) != null) {
            ContentValues values = new ContentValues();
            values.put(MediaStore.Images.Media.TITLE, "abs_" + System.currentTimeMillis() + ".jpeg");
    ...
    public static Intent getPickImageChooserIntent(@NonNull Context context) {
        return getPickImageChooserIntent(context, context.getString(R.string.pickimage), false, true);
    }
    ...
    public static List<Intent> getCameraIntents(@NonNull Context context, @NonNull PackageManager packageManager) {
        ...
        for (ResolveInfo res : listCam) {
            ...
            if (outputFileUri != null) {
                ContentValues values = new ContentValues();
                values.put(MediaStore.Images.Media.TITLE, outputFileUri.toString());
                outputFileUri = context.getContentResolver().insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values);
                intent.putExtra(MediaStore.EXTRA_OUTPUT, outputFileUri);
    ...
    /**
     * Check if explicitly requesting storage permission is required.<br>
     * It is required in Android Marshmellow and above if "READ_EXTERNAL_STORAGE" permission is requested in the manifest.<br>
     * See <a href="http://stackoverflow.com/questions/32789027/android-m-storage-intent-permission-bug">StackOverflow
     * question</a>.
     */
    public static boolean isExplicitStoragePermissionRequired(@NonNull Context context) {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.M &&
                hasPermissionInManifest(context, "android.permission.READ_EXTERNAL_STORAGE") &&
    ...
    /**
     * Create {@link CropOptionsBuilder} instance to open image picker for cropping and then start
     * {@link ImageCropperActivity} to crop the selected image.<br>
     ...
     */
    public static CropOptionsBuilder activity() {
        return new CropOptionsBuilder(null);
    }

    /**
     * Create {@link CropOptionsBuilder} instance to start {@link ImageCropperActivity} to crop the given image.<br>
     * Result will be received in {@link Activity#onActivityResult(int, int, Intent)} and can be retrieved
     * using {@link #getActivityResult(Intent)}.
     *
     ...
     * @return builder for Crop Image Activity
     */
    public static CropOptionsBuilder activity(@Nullable Uri uri) {
        return new CropOptionsBuilder(uri);
    }

    /**
     * Get {@link ImageCropperActivity} result data object for crop image activity started using {@link #activity(Uri)}.
     *
    ...
    public static final class CropOptionsBuilder {
         ...
         */
        private final ImageCropperOptions mOptions;
        private CropOptionsBuilder(@Nullable Uri source) {
            mSource = source;
            mOptions = new ImageCropperOptions();
        }

        /**
         * Get {@link ImageCropperActivity} intent to start the activity.
         */
        public Intent getIntent(@NonNull Context context) {
            return getIntent(context, ImageCropperActivity.class);
        }
        ...
        /**
         * Start {@link ImageCropperActivity}.
         *
         ...
         */
        public CropOptionsBuilder setCropShape(@NonNull CropImageView.CropShape cropShape) {
         ...
         * <i>Default: 3dp</i>
         */
        public CropOptionsBuilder setSnapRadius(float snapRadius) {
         ...
         * <i>Default: 48dp</i>
         */
        public CropOptionsBuilder setTouchRadius(float touchRadius) {
         ...
         */
        public CropOptionsBuilder setGuidelines(@NonNull CropImageView.Guidelines guidelines) {
         ...
         */
        public CropOptionsBuilder setScaleType(@NonNull CropImageView.ScaleType scaleType) {
         ...
         */
        public CropOptionsBuilder setShowCropOverlay(boolean showCropOverlay) {
         ...
         * default: true.
         */
        public CropOptionsBuilder setAutoZoomEnabled(boolean autoZoomEnabled) {
         ...
         * default: true.
         */
        public CropOptionsBuilder setMultiTouchEnabled(boolean multiTouchEnabled) {
         ...
         * <i>Default: 4</i>
         */
        public CropOptionsBuilder setMaxZoom(int maxZoom) {
         ...
         * <i>Default: 0.1</i>
         */
        public CropOptionsBuilder setInitialCropWindowPaddingRatio(float initialCropWindowPaddingRatio) {
         ...
         * <i>Default: false</i>
         */
        public CropOptionsBuilder setFixAspectRatio(boolean fixAspectRatio) {
         ...
         */
        public CropOptionsBuilder setAspectRatio(int aspectRatioX, int aspectRatioY) {
         ...
         * <i>Default: 3dp</i>
         */
        public CropOptionsBuilder setBorderLineThickness(float borderLineThickness) {
         ...
         */
        public CropOptionsBuilder setBorderLineColor(int borderLineColor) {
         ...
         * <i>Default: 2dp</i>
         */
        public CropOptionsBuilder setBorderCornerThickness(float borderCornerThickness) {
         ...
         * <i>Default: 5dp</i>
         */
        public CropOptionsBuilder setBorderCornerOffset(float borderCornerOffset) {
         ...
         * <i>Default: 14dp</i>
         */
        public CropOptionsBuilder setBorderCornerLength(float borderCornerLength) {
         ...
         * <i>Default: WHITE</i>
         */
        public CropOptionsBuilder setBorderCornerColor(int borderCornerColor) {
         ...
         * <i>Default: 1dp</i>
         */
        public CropOptionsBuilder setGuidelinesThickness(float guidelinesThickness) {
         ...
         * <i>Default: Color.argb(170, 255, 255, 255)</i>
         */
        public CropOptionsBuilder setGuidelinesColor(int guidelinesColor) {
            mOptions.guidelinesColor = guidelinesColor;
            return this;
        }

        /**
         * the color of the toolbar of image cropper activity.<br>
         * <i>Default: color white</i>
         */
        public CropOptionsBuilder setActionbarColor(int toolbarColor) {
            mOptions.toolbarColor = toolbarColor;
            return this;
        }
         ...
         */
        public CropOptionsBuilder setBackgroundColor(int backgroundColor) {
         ...
         */
        public CropOptionsBuilder setMinCropWindowSize(int minCropWindowWidth, int minCropWindowHeight) {
         ...
         */
        public CropOptionsBuilder setMinCropResultSize(int minCropResultWidth, int minCropResultHeight) {
         ...
         */
        public CropOptionsBuilder setMaxCropResultSize(int maxCropResultWidth, int maxCropResultHeight) {
        ...
        /**
         * the title of the {@link ImageCropperActivity}.<br>
         * <i>Default: ""</i>
         */
        public CropOptionsBuilder setActivityTitle(String activityTitle) {
         ...
         * <i>Default: NONE</i>
         */
        public CropOptionsBuilder setActivityMenuIconColor(int activityMenuIconColor) {
         ...
         */
        public CropOptionsBuilder setOutputUri(Uri outputUri) {
         ...
         * <i>Default: JPEG</i>
         */
        public CropOptionsBuilder setOutputCompressFormat(Bitmap.CompressFormat outputCompressFormat) {
         ...
         * <i>Default: 90</i>
         */
        public CropOptionsBuilder setOutputCompressQuality(int outputCompressQuality) {
         ...
         */
        public CropOptionsBuilder setRequestedSize(int reqWidth, int reqHeight) {
         ...
         * <i>Default: 0, 0 - not set, will not resize</i>
         */
        public CropOptionsBuilder setRequestedSize(int reqWidth, int reqHeight, CropImageView.RequestSizeOptions options) {
         ...
         * <i>Default: false</i>
         */
        public CropOptionsBuilder setNoOutputImage(boolean noOutputImage) {
         ...
         */
        public CropOptionsBuilder setInitialCropWindowRectangle(Rect initialCropWindowRectangle) {
         ...
         */
        public CropOptionsBuilder setInitialRotation(int initialRotation) {
         ...
         * <i>Default: true</i>
         */
        public CropOptionsBuilder setAllowRotation(boolean allowRotation) {
         ...
         * <i>Default: true</i>
         */
        public CropOptionsBuilder setAllowFlipping(boolean allowFlipping) {
         ...
         * <i>Default: false</i>
         */
        public CropOptionsBuilder setAllowCounterRotation(boolean allowCounterRotation) {
         ...
         * <i>Default: 90</i>
         */
        public CropOptionsBuilder setRotationDegrees(int rotationDegrees) {
         ...
         * <i>Default: false</i>
         */
        public CropOptionsBuilder setFlipHorizontally(boolean flipHorizontally) {
         ...
         * <i>Default: false</i>
         */
        public CropOptionsBuilder setFlipVertically(boolean flipVertically) {
