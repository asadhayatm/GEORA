 ...
 */
public class ImageCropperOptions implements Parcelable {

    public static final Creator<ImageCropperOptions> CREATOR = new Creator<ImageCropperOptions>() {
        @Override
        public ImageCropperOptions createFromParcel(Parcel in) {
            return new ImageCropperOptions(in);
        }

        @Override
        public ImageCropperOptions[] newArray(int size) {
            return new ImageCropperOptions[size];
        }
    };
   ...
   */
    ...
    /**
     * the title of the {@link ImageCropperActivity}
     */
    ...
    /**
     * toolbar color of cropper activity
     */
    public int toolbarColor= Color.WHITE;

    /**
     * Init options with defaults.
     */
    public ImageCropperOptions() {
     ...
     */
    protected ImageCropperOptions(Parcel in) {
