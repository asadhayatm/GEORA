...
import static com.dnitinverma.amazons3library.AmazonS3Constants.AMAZON_POOLID;
...
public class AmazonUtils {
    ...
    public static AmazonS3Client getS3Client(Context context) {
        if (sS3Client == null) {
            ...
            sS3Client.setEndpoint(AmazonS3Constants.END_POINT);
        }
        return sS3Client;
    }
    ...
    public static CognitoCachingCredentialsProvider getCredProvider(Context context) {
        if (sCredProvider == null) {
            sCredProvider = new CognitoCachingCredentialsProvider(
                    context, AmazonS3Constants.AMAZON_POOLID, // Identity Pool ID
